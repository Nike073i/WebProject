...
using WorldOfPowerToolsTest.Controllers;
...
namespace SportsStore.Tests
{
    ...
    public class ProductControllerTests
    {
        ...
        public void Generate_Category_Specific_Product_Count()
        {
            ...
            // Action
            int? res1 = GetModel(target.List("Cat1"))?.PagingInfo.Totalltems;
            int? res2 = GetModel(target.List("Cat2"))?.PagingInfo.Totalltems;
            int? res3 = GetModel(target.List("Cat3"))?.PagingInfo.Totalltems;
            int? resAll = GetModel(target.List(null))?.PagingInfo.Totalltems;
